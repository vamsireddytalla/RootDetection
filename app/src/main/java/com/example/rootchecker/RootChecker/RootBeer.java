...
public class RootBeer {
    ...
    public boolean isRooted() {
        ...
        return detectRootManagementApps() || detectPotentiallyDangerousApps() || checkForBinary(Const.BINARY_SU)
    ...
    public boolean checkForBinary(String filename) {
        ...
        for (String path : pathsArray) {
            ...
            if (fileExists) {
                Log.d(TAG, completePath+" binary detected!");
                result = true;
            }
        }
    ...
    private boolean isAnyPackageFromListInstalled(List<String> packages){
        ...
        for (String packageName : packages) {
            try {
                ...
                Log.d(TAG, packageName + " ROOT management app detected!");
                result = true;
            ...
            for (String key : dangerousProps.keySet()) {
                if (line.contains(key)) {
                    ...
                    if (line.contains(badValue)) {
                        Log.d(TAG, key + " = " + badValue + " detected!");
                        result = true;
                    }
                }
            }
    ...
    public boolean checkForRWPaths() {
        ...
        for (String line : lines) {
            ...
            if ((sdkVersion <= android.os.Build.VERSION_CODES.M && args.length < 4)
                ...
                Log.d(TAG, "Error formatting mount line: "+line);
                continue;
            }
                ...
                if (mountPoint.equalsIgnoreCase(pathToCheck)) {
                    ...
                    for (String option : mountOptions.split(",")){
                        ...
                        if (option.equalsIgnoreCase("rw")){
                            Log.d(TAG, pathToCheck+" path is mounted with rw permissions! "+line);
                            result = true;
                            break;
                        }
                    }
    ...
    public boolean checkForRootNative() {
        ...
        if (!canLoadNativeLibrary()){
            Log.d(TAG, "We could not load the native library to test for root");
            return false;
        }
